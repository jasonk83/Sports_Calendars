...
def fetch_espn_schedule(sport, league, team_abbr, emoji, output_file):
    ...
    for item in data.get("events", []):
        ...
        time_str = item.get("date") # ESPN format: 2026-10-25T23:30Z
        if not time_str:
            continue
        ...
        try:
            ...
            event.end = eastern_time + timedelta(hours=2, minutes=30) 
...
if __name__ == "__main__":
    # Fetch Boston Celtics
    fetch_espn_schedule("basketball", "nba", "bos", "🏀", "celtics_schedule.ics")
